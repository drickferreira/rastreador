<?php namespace Modules\Companies\Providers;
...
class CompaniesServiceProvider extends ServiceProvider {
	...
	{
		$viewPath = base_path('resources/views/modules/companies');
		...
		$this->loadViewsFrom([$viewPath, $sourcePath], 'companies');
	}
	...
	{
		$langPath = base_path('resources/lang/modules/companies');
